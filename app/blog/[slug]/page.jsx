import { getBlogBySlug, getBlogFileNames, getBlogs } from "@/utils/blog";
...
const getInitialBlog = async (slug) => {
  const allBlogs = getBlogFileNames().map(name => name.split('.')[0]);
  if(allBlogs.includes(slug)) {
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  <article className="banana-blog prose lg:prose-xl">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="pt-2 pb-6 mx-auto">
                <Breadcrumb
                  pageName="Article"
                  prevPage="Blog"
                  prevPagePath="/blog"
              ...
              <div className="mb-10 rounded-md bg-primary bg-opacity-5 dark:bg-opacity-10">
                <h3 className="border-b border-body-color border-opacity-10 py-4 px-8 text-lg font-semibold text-black dark:border-white dark:border-opacity-10 dark:text-white mb-0">
                  Related Posts
                </h3>
                <ul className="p-8">
